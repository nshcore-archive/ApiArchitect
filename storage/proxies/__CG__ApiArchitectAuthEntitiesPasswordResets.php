 ...
 */
class PasswordResets extends \ApiArchitect\Auth\Entities\PasswordResets implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'user', 'token', 'used', 'name', 'id', 'nid', 'nodeType'];
        }

        return ['__isInitialized__', 'user', 'token', 'used', 'id', 'nid'];
    }
