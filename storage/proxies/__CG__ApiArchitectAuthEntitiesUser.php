...
namespace 1\__CG__\ApiArchitect\Auth\Entities;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \ApiArchitect\Auth\Entities\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'firstName', 'lastName', 'enabled', 'roles', 'username', 'email', 'password', 'permissions', 'rememberToken', 'avatar', 'OTP', 'socialAccounts', 'name', 'id', 'nid', 'nodeType'];
        }

        return ['__isInitialized__', 'firstName', 'lastName', 'enabled', 'roles', 'username', 'email', 'password', 'permissions', 'rememberToken', 'avatar', 'OTP', 'socialAccounts', 'id', 'nid'];
    }
     ...
     * {@inheritDoc}
     */
    public function addRoles(\ApiArchitect\Auth\Entities\Role $role)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addRoles', [$role]);

        return parent::addRoles($role);
    }
     ...
     * {@inheritDoc}
     */
    public function addSocialAccount(\ApiArchitect\Auth\Entities\Social\SocialAccount $socialAccount)
    {
     ...
     * {@inheritDoc}
     */
    public function removeSocialAccount(\ApiArchitect\Auth\Entities\Social\SocialAccount $socialAccount)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeSocialAccount', [$socialAccount]);

        return parent::removeSocialAccount($socialAccount);
    }
