 ...
 */
class RequestLog extends \ApiArchitect\Log\Entities\RequestLog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'route', 'method', 'params', 'version', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RequestLog $proxy) {
