...
namespace 1\__CG__\ApiArchitect\Log\Entities;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class DatabaseLog extends \ApiArchitect\Log\Entities\DatabaseLog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'action', 'objectId', 'objectClass', 'version', 'data', 'username', 'loggedAt', 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DatabaseLog $proxy) {
